...
public class TestControllerCompanyB {
	...
	public Company firstPage() {
		...
		cmp.setName("DEF");
		cmp.setNumber_of_shares(2000);
		cmp.setPrice_of_shares(60);
		cmp.setShares_doubles_when(800);
		return cmp;
	}
...
//	    ResponseUpgrade response= null;
		if (response != null) {
			...
			try {
				...
				String q="select Number_of_shares from company_b WHERE name='"+response.getSeller()+"'";
				...
				String r="UPDATE company_b SET Number_of_shares="+seller_shares_after+" WHERE name='"+response.getSeller()+"'";
				...
				String s="SELECT Number_of_shares from company_b WHERE name='"+response.getBuyer()+"'";
				...
				String t="UPDATE company_b SET Number_of_shares="+buyer_shares_after+" WHERE name='"+response.getBuyer()+"'";
